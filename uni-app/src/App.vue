...
<style lang="scss">
	...
	// 圆形指示点
	.circular {
		::v-deep .uni-swiper-dot,::v-deep .wx-swiper-dot {
			width: 10rpx;
			height: 10rpx;
			background: rgba(0, 0, 0, .4);
		}
		::v-deep .uni-swiper-dot-active,::v-deep .wx-swiper-dot-active {
			background: #fff;
		}
	}
	// 方形指示点
	...
	::v-deep .swiper.dot0 .uni-swiper-dots,::v-deep .swiper.dot0 .wx-swiper-dots{
		left: 130rpx;
	}
	::v-deep .swiper.dot1 .uni-swiper-dots,::v-deep .swiper.dot1 .wx-swiper-dots{
		left: 50%;
	}
	::v-deep .swiper.dot2 .uni-swiper-dots,::v-deep .swiper.dot2 .wx-swiper-dots{
		right: 130rpx;
	}
</style>
