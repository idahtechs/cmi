	 ...
	 class="store-home">
		...
		<view class="header">
			<view class="head-menu">
				...
				<view class="iconfont icon-shouye4" style="color: #fff;"></view>
			</view>
		...
		<view class="header">
			<view class="head-menu">
				...
				<view class="iconfont icon-shouye4"></view>
			</view>
			<view class="search"><text class="iconfont icon-xiazai5"></text>搜索商品</view>
		</view>
		<!-- #endif -->
...
<style lang="scss" scoped>
	...
	.column {
		...
		.item {
			...
			::v-deep .image,::v-deep .easy-loadimage,::v-deep image,::v-deep uni-image {
				width: 260rpx;
				height: 260rpx;
				border-radius: 16rpx;
				overflow: hidden;
