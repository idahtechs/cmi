...
.index-product-wrapper {
	...
	.list-box {
		...
		.item {
			...
			.pictrue,::v-deep image,::v-deep .easy-loadimage,::v-deep uni-image {
				width: 100%;
				display: block;
				position: relative;
				.border-picture {
			...
			.picture1,::v-deep .picture1 image,::v-deep .picture1 .easy-loadimage,::v-deep .picture1 uni-image {			
				height: 346rpx;
				position: relative;
				.border-picture {
					position: absolute;
			...
			.cont1,::v-deep .cont1 image,::v-deep .cont1 .easy-loadimage,::v-deep .cont1 uni-image,.cont1 .border-picture{
				border-radius: 16rpx;
			}
			.text-info {
