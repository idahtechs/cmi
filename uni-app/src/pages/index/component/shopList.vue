...
.explosion {
	...
	.mer-box {
		...
		.mer-item {
			...
			::v-deep .easy-loadimage,::v-deep uni-image,image,::v-deep .loadfail-img{
				width: 100%;
				height: 214rpx;
			}
			.pro-box {
				...
				.pro-item {
					width: 31.3%;
					margin-right: 3.05%;
					.picture,::v-deep .easy-loadimage,::v-deep uni-image,::v-deep image,::v-deep .loadfail-img {
						width: 100%;
						height: 214rpx;
						position: relative;
					}
...
.mer_count{
	...
	.item{
		...
		align-items: center;
		justify-content: center;
		::v-deep uni-image,::v-deep image,::v-deep .easy-loadimage{
			width: 100%!important;
			max-height: 140rpx;
		}
		&:nth-child(4n){
