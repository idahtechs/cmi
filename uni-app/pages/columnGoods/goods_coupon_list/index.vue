<template>
	<view :style="viewColor">
		<view class='productList'>
			...
			<rightSlider v-if="rightBox" :price_on="where.price_on" :price_off="where.price_off" :status="rightBox" :brandList="brandList" @confirm="confirm" @close="close"></rightSlider>
		</view>
