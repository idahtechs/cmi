					...
					<view v-if="hide_mer_status == 0 && storeInfo.merchant" class="store-wrapper">
						<view class="store-hd skeleton-rect">
							<view class="store-info">
								...
								<navigator :url="'/pages/store/home/index?id='+storeInfo.merchant.mer_id" hover-class="none" class="info">
			...
			<view class='footer_count'>
				<view class="acea-row row-between-wrapper footer">
					<block v-if="storeInfo.merchant">
						<view v-if="storeInfo.merchant.services_type== 0" class="item skeleton-rect" @click="couponTap2">
							<view class="iconfont icon-kefu"></view>
							<view>客服</view>
						</view>
						<view v-else-if="storeInfo.merchant.services_type== 1" class="item skeleton-rect" @click="call(1)">
							<view class="iconfont icon-kefu"></view>
							<view>客服</view>
						</view>
						<view v-else class="item skeleton-rect" @click="call(0)">
							<view class="iconfont icon-kefu"></view>
							<view>客服</view>
						</view>
					</block>
