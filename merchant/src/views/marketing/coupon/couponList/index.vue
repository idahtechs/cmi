<template>
  <div class="divBox">
        ...
        <div class="container">
          <el-form size="small" label-width="120px" :inline="true">
            ...
            <el-form-item label="优惠券名称：">
              <el-input v-model="tableFrom.coupon_name" placeholder="请输入优惠券名称" class="selWidth mr20" clearable @keyup.enter.native="getList(1)">
      ...
      >
        ...
        <el-table-column label="操作" min-width="150" fixed="right">
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" class="mr10" @click="onEdit(scope.row.coupon_id)">编辑</el-button>
    ...
    <!--优惠券详情-->
    <el-dialog v-if="detailDialog" title="优惠券详情" :visible.sync="detailDialog" width="700px">
      <div>
        <div class="box-container">
          ...
          <div class="list sp100">
            ...
            <span v-if="couponDetail.is_timeout == 1" class="info">{{ couponDetail.start_time }} - {{ couponDetail.end_time }}</span>
            <span v-else class="info">不限时</span>
          </div>
          <div class="list sp">
            <label class="name">获取方式：</label>
            <span v-if="couponDetail.send_type == 0" class="info">手动领取</span>
            <span v-if="couponDetail.send_type == 1" class="info">消费满赠券</span>
            <span v-if="couponDetail.send_type == 2" class="info">新人券</span>
            <span v-if="couponDetail.send_type == 3" class="info">买赠券</span>
            <span v-if="couponDetail.send_type == 4" class="info">收单赠送券</span>
            <span v-if="couponDetail.send_type == 5" class="info">会员赠送券</span>
          </div>
          <div class="list sp">
          ...
          <div class="list sp">
            ...
            <span class="info">{{ couponDetail.create_time }}</span>
          </div>
          <div class="list sp">
          ...
          <div v-if="type == 1" class="list sp100">
