  ...
  <div class="divBox">
    <el-card class="box-card">
        ...
        <div class="container">
          <el-form size="small" label-width="120px" inline>
            ...
            <el-form-item label="退款类型：" class="width100">
             ...
             <el-form-item label="退款发起方：" class="width100">
              <el-select
      ...
      >
        ...
        <el-table-column prop="refund_price" label="退款金额" min-width="90" />
        <el-table-column prop="nickname" label="商品信息" min-width="280">
          <template slot-scope="scope">
            <div
        ...
        <el-table-column prop="order.real_name" label="退货人" min-width="100" />
        <el-table-column prop="create_user" label="退款发起方" min-width="120" />
