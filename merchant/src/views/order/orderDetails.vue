        ...
        <div class="head">
          ...
          <ul class="list">
            <li class="item">
              ...
              <div>
                <div v-if="orderDetailList.order_type === 0 && !orderDetailList.pay_time" class="value1">待付款<span v-if="orderDetailList.is_del>0" style="color:rgb(237,64,20);font-size:12px;">（用户已删除）</span></div>
