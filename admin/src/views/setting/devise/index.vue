                    ...
                    <div class="wrapper" :style="'height:'+ (clientHeight-46) + 'px;'" v-if="tabCur == 0">
                        <div v-for="(item, index) in leftMenu" :key="index">
                            ...
                            <draggable
                                ...
                                :clone="cloneDog"
                                dragClass="dragClass"
                                filter=".search, .navbar, .comb"
                            >
                                <div
                                    class="list-group-item"
                                    :class="{ search: element.cname == '搜索框', navbar: element.cname == '商品分类', comb: element.cname == '组合组件', }"
                        ...
                        <div class="contxt"
                            ...
                            <div class="scrollCon">
                                <div style="width: 400px;margin: 0 auto;position:relative;">
                                    <div class="scroll-box" :class="picTxt&&tabValTxt==2?'fullsize noRepeat':picTxt&&tabValTxt==1?'repeat ysize':'noRepeat ysize'" :style="'background-color:'+(colorTxt?colorPickerTxt:'')+';background-image: url('+(picTxt?picUrlTxt:'')+');'" ref="imgContainer">
                                        <draggable
                                            class="dragArea list-group"
                                            :list="mConfig"
                                            group="people"
...
import img01 from '@/assets/images/foot-002.png'
let idGlobal = 0;
export default {
    inject: ['reload'],
    name: "index.vue",
