      ...
      <div slot="header" class="clearfix">
        <div class="container">
          <el-form size="small" inline label-width="100px">
            ...
            <!-- <el-form-item label="支付方式：" style="display: inline-block;">
              <el-select
            ...
            <el-form-item label="推广人：" class="width100" style="display: inline-block;">
              <el-input
            ...
            <el-form-item label="上级推广人：" class="width100" style="display: inline-block;">
              <el-input
